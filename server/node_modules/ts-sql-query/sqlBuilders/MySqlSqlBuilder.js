...
class MySqlSqlBuilder extends AbstractMySqlMariaBDSqlBuilder_1.AbstractMySqlMariaDBSqlBuilder {
    ...
    _appendColumnValue(value, params, isOutermostQuery) {
        if (isOutermostQuery && this._getUuidStrategy() === 'binary') {
            if ((0, values_1.__getValueSourcePrivate)(value).__valueType === 'uuid') {
    ...
    _appendAggragateArrayColumns(aggregatedArrayColumns, params, _query) {
        if ((0, values_1.isValueSource)(aggregatedArrayColumns)) {
            if ((0, values_1.__getValueSourcePrivate)(aggregatedArrayColumns).__valueType === 'uuid' && this._getUuidStrategy() === 'binary') {
            ...
            for (let prop in columns) {
                ...
                if ((0, values_1.__getValueSourcePrivate)(column).__valueType === 'uuid' && this._getUuidStrategy() === 'binary') {
