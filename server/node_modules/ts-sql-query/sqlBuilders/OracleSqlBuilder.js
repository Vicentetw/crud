...
class OracleSqlBuilder extends AbstractSqlBuilder_1.AbstractSqlBuilder {
    ...
    _appendAggragateArrayColumns(aggregatedArrayColumns, params, _query) {
        if ((0, values_1.isValueSource)(aggregatedArrayColumns)) {
            if ((0, values_2.__getValueSourcePrivate)(aggregatedArrayColumns).__valueType === 'uuid' && this._getUuidStrategy() === 'custom-functions') {
            ...
            for (let prop in columns) {
                ...
                if ((0, values_2.__getValueSourcePrivate)(column).__valueType === 'uuid' && this._getUuidStrategy() === 'custom-functions') {
