...
class AbstractSqlBuilder {
    ...
    _appendSpreadValue(value, params, columnType, typeAdapter) {
    ...
    _buildSelectOrderBy(query, params) {
        ...
        for (const property in orderBy) {
            ...
            const column = (0, SqlBuilder_1.getQueryColumn)(columns, property);
            if (!column) {
            ...
            if (!order) {
                ...
                switch (order) {
                    ...
                    case 'desc nulls last insensitive': {
                        ...
                        const columnType = (0, values_2.__getValueSourcePrivate)(column).__valueType;
    ...
    _buildInsertFromSelect(query, params) {
        ...
        for (var columnName in table) {
            ...
            selectColumns[columnName] = new ValueSourceImpl_1.SequenceValueSource('_nextSequenceValue', columnPrivate.__sequenceName, columnPrivate.__valueType, 'required', columnPrivate.__typeAdapter);
        }
    ...
    _extractAdditionalRequiredTablesForUpdate(query, _params) {
        ...
        for (let property in sets) {
            (0, ITableOrView_1.__registerTableOrView)(sets[property], result);
        }
        const columns = query.__columns;
        if (columns) {
            for (let property in columns) {
                (0, ITableOrView_1.__registerTableOrView)(columns[property], result);
            }
        }
    ...
    _extractAdditionalRequiredColumnsForUpdate(query, requiredTables, _params) {
        ...
        const sets = query.__sets;
        for (let property in sets) {
            (0, ITableOrView_1.__registerRequiredColumn)(sets[property], result, requiredTables);
        }
        const columns = query.__columns;
        if (columns) {
            for (let property in columns) {
                (0, ITableOrView_1.__registerRequiredColumn)(columns[property], result, requiredTables);
            }
        }
        if (result.size <= 0) {
            return undefined;
    ...
    _lessThan(params, valueSource, value, columnType, typeAdapter) {
        return this._appendSqlParenthesis(valueSource, params) + ' < ' + this._appendValueParenthesis(value, params, columnType, typeAdapter);
    }
    _greaterThan(params, valueSource, value, columnType, typeAdapter) {
        return this._appendSqlParenthesis(valueSource, params) + ' > ' + this._appendValueParenthesis(value, params, columnType, typeAdapter);
    }
    _lessOrEquals(params, valueSource, value, columnType, typeAdapter) {
        return this._appendSqlParenthesis(valueSource, params) + ' <= ' + this._appendValueParenthesis(value, params, columnType, typeAdapter);
    }
    _greaterOrEquals(params, valueSource, value, columnType, typeAdapter) {
        return this._appendSqlParenthesis(valueSource, params) + ' >= ' + this._appendValueParenthesis(value, params, columnType, typeAdapter);
    }
    ...
    _startsWith(params, valueSource, value, columnType, typeAdapter) {
        return this._appendSqlParenthesis(valueSource, params) + ' like (' + this._escapeLikeWildcard(params, value, columnType, typeAdapter) + " || '%')";
    }
    _notStartsWith(params, valueSource, value, columnType, typeAdapter) {
    ...
    _endsWith(params, valueSource, value, columnType, typeAdapter) {
        return this._appendSqlParenthesis(valueSource, params) + " like ('%' || " + this._escapeLikeWildcard(params, value, columnType, typeAdapter) + ')';
    }
    _notEndsWith(params, valueSource, value, columnType, typeAdapter) {
        return this._appendSqlParenthesis(valueSource, params) + " not like ('%' || " + this._escapeLikeWildcard(params, value, columnType, typeAdapter) + ')';
    }
    ...
    _substrToEnd(params, valueSource, value, _columnType, typeAdapter) {
        if (typeof value === 'number') {
    ...
    _substringToEnd(params, valueSource, value, _columnType, typeAdapter) {
        if (typeof value === 'number') {
            return 'substr(' + this._appendSql(valueSource, params) + ', ' + this._appendValue(value + 1, params, 'int', typeAdapter) + ')';
        }
        else {
    ...
    _getMathArgumentType(columnType, value) {
        if (typeof value === 'number') {
    ...
    _modulo(params, valueSource, value, columnType, typeAdapter) {
    ...
    // SqlFunction2
    _substr(params, valueSource, value, value2, _columnType, typeAdapter) {
        if (typeof value === 'number') {
    ...
    _substring(params, valueSource, value, value2, _columnType, typeAdapter) {
    ...
    _replaceAll(params, valueSource, value, value2, columnType, typeAdapter) {
    ...
    _rawFragmentTableName(_params, tableOrView) {
        const name = (0, ITableOrView_2.__getTableOrViewPrivate)(tableOrView).__name;
