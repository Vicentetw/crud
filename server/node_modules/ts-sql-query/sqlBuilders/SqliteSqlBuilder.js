...
class SqliteSqlBuilder extends AbstractSqlBuilder_1.AbstractSqlBuilder {
    ...
    _getValueSourceDateTimeFormat(valueSource) {
        if ((0, values_1.isValueSource)(valueSource)) {
            const type = (0, values_2.__getValueSourcePrivate)(valueSource).__valueType;
            switch (type) {
                case 'localDate':
    ...
    __appendColumnAliasInsensitive(identifier, column, params) {
    ...
    _appendColumnValue(value, params, isOutermostQuery) {
        if (isOutermostQuery && this._getUuidStrategy() === 'uuid-extension') {
            if ((0, values_2.__getValueSourcePrivate)(value).__valueType === 'uuid') {
    ...
    _appendAggragateArrayColumns(aggregatedArrayColumns, params, _query) {
        if ((0, values_1.isValueSource)(aggregatedArrayColumns)) {
            if ((0, values_2.__getValueSourcePrivate)(aggregatedArrayColumns).__valueType === 'uuid' && this._getUuidStrategy() === 'uuid-extension') {
            ...
            for (let prop in columns) {
                ...
                if ((0, values_2.__getValueSourcePrivate)(column).__valueType === 'uuid' && this._getUuidStrategy() === 'uuid-extension') {
