import { ToSql, SelectData, InsertData, DeleteData, UpdateData, QueryColumns } from "./SqlBuilder";
import { TypeAdapter } from "../TypeAdapter";
import { AnyValueSource, IExecutableSelectQuery, __AggregatedArrayColumns } from "../expressions/values";
...
export declare class SqlServerSqlBuilder extends AbstractSqlBuilder {
    ...
    __appendColumnAliasInsensitive(identifier: string, column: AnyValueSource, params: any[]): string;
