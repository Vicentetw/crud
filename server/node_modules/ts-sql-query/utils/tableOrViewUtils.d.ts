...
export declare type OuterJoinTableOrView<TABLE_OR_VIEW extends ITableOrView<any>, ALIAS> = {
    [K in ValueSourcesOf<TABLE_OR_VIEW>]: RemapValueSourceTypeWithOptionalType<OUTER_JOIN_SOURCE<TABLE_OR_VIEW[typeof tableOrViewRef], ALIAS>, TABLE_OR_VIEW[K], OuterOptionalTypeOf<TABLE_OR_VIEW[K]>>;
} & TableOrViewOuterJoin<TABLE_OR_VIEW, ALIAS>;
...
declare type CustomizedTableOrViewType<TABLE_OR_VIEW extends ITableOrView<any>, REF extends TableOrViewRef<AnyDB>> = TABLE_OR_VIEW extends TableOrViewAlias<infer T, infer ALIAS> ? (T extends ITable<any> ? TableOrViewAlias<ITable<REF>, ALIAS> : T extends IView<any> ? TableOrViewAlias<IView<REF>, ALIAS> : T extends IWithView<any> ? TableOrViewAlias<IWithView<REF>, ALIAS> : never) : TABLE_OR_VIEW extends ITable<any> ? ITable<REF> : TABLE_OR_VIEW extends IView<any> ? IView<REF> : TABLE_OR_VIEW extends IWithView<any> ? IWithView<REF> : never;
