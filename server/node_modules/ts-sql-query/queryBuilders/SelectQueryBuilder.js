...
class AbstractSelect extends ComposeSliptQueryBuilder_1.ComposeSplitQueryBuilder {
    ...
    __executeSelectCount(source) {
        try {
            this.__sqlBuilder._resetUnique();
            const countAll = new ValueSourceImpl_1.AggregateFunctions0ValueSource('_countAll', 'int', 'required', undefined);
            const params = [];
    ...
    limit(limit) {
        ...
        this.__query = '';
        this.__limit = limit;
        (0, ITableOrView_2.__addWiths)(limit, this.__withs);
        return this;
    }
    limitIfValue(limit) {
    ...
    offset(offset) {
        ...
        (0, ITableOrView_2.__addWiths)(offset, this.__withs);
        return this;
    }
    ...
    __addWiths(withs) {
        ...
        for (let i = 0, length = withViews.length; i < length; i++) {
            ...
            (0, ITableOrView_2.__getTableOrViewPrivate)(withView).__addWiths(withs);
        }
    }
    __registerTableOrView(requiredTablesOrViews) {
        ...
        for (let i = 0, length = subSelectUsing.length; i < length; i++) {
            ...
            (0, ITableOrView_2.__getTableOrViewPrivate)(tableOrView).__registerTableOrView(requiredTablesOrViews);
        }
    }
    __registerRequiredColumn(requiredColumns, onlyForTablesOrViews) {
        ...
        (0, ITableOrView_1.__registerRequiredColumn)(this.__orderBy, requiredColumns, newOnly);
        (0, ITableOrView_1.__registerRequiredColumn)(this.__limit, requiredColumns, newOnly);
        (0, ITableOrView_1.__registerRequiredColumn)(this.__offset, requiredColumns, newOnly);
        const customization = this.__customization;
        if (customization) {
            (0, ITableOrView_1.__registerRequiredColumn)(customization.afterSelectKeyword, requiredColumns, newOnly);
            (0, ITableOrView_1.__registerRequiredColumn)(customization.beforeColumns, requiredColumns, newOnly);
            (0, ITableOrView_1.__registerRequiredColumn)(customization.customWindow, requiredColumns, newOnly);
            (0, ITableOrView_1.__registerRequiredColumn)(customization.afterQuery, requiredColumns, newOnly);
        }
    ...
    __getOldValues() {
        ...
        for (let i = 0, length = subSelectUsing.length; i < length; i++) {
            const tableOrView = subSelectUsing[i];
            const result = (0, ITableOrView_2.__getTableOrViewPrivate)(tableOrView).__getOldValues();
            if (result) {
                return result;
            }
        }
    ...
    forUseInQueryAs(as) {
        ...
        return new WithViewImpl_1.WithViewImpl(as, this.__asSelectData());
    }
    forUseAsInlineQueryValue() {
        return new ValueSourceImpl_1.InlineSelectValueSource(this.__asSelectData());
    }
    forUseAsInlineAggregatedArrayValue() {
        const selectData = this.__asSelectData();
        selectData.__asInlineAggregatedArrayValue = true;
        const result = new ValueSourceImpl_1.InlineSelectValueSource(selectData);
        if (this.__oneColumn) {
    ...
    __buildRecursive(fn, unionAll) {
        ...
        const recursiveInternalView = new WithViewImpl_1.WithViewImpl(name, this);
        ...
        const recursiveView = new WithViewImpl_1.WithViewImpl(name, recursiveInternalSelect);
    ...
    customizeQuery(customization) {
        ...
        (0, ITableOrView_2.__addWiths)(customization.afterSelectKeyword, this.__withs);
        (0, ITableOrView_2.__addWiths)(customization.beforeColumns, this.__withs);
        (0, ITableOrView_2.__addWiths)(customization.customWindow, this.__withs);
        (0, ITableOrView_2.__addWiths)(customization.afterQuery, this.__withs);
        return this;
    }
}
...
class SelectQueryBuilder extends AbstractSelect {
    constructor(sqlBuilder, tables, distinct) {
        ...
        for (let i = 0, length = tables.length; i < length; i++) {
            ...
            (0, ITableOrView_2.__getTableOrViewPrivate)(table).__addWiths(this.__withs);
        }
    }
    __registerRequiredColumnInSelect(requiredColumns, onlyForTablesOrViews) {
        const tablesOrViews = this.__tablesOrViews;
        for (let i = 0, length = tablesOrViews.length; i < length; i++) {
            (0, ITableOrView_1.__registerRequiredColumn)(tablesOrViews[i], requiredColumns, onlyForTablesOrViews);
        }
        const joins = this.__joins;
        for (let i = 0, length = joins.length; i < length; i++) {
            const join = joins[i];
            (0, ITableOrView_1.__registerRequiredColumn)(join.__tableOrView, requiredColumns, onlyForTablesOrViews);
            (0, ITableOrView_1.__registerRequiredColumn)(join.__on, requiredColumns, onlyForTablesOrViews);
        }
        (0, ITableOrView_1.__registerRequiredColumn)(this.__where, requiredColumns, onlyForTablesOrViews);
        (0, ITableOrView_1.__registerRequiredColumn)(this.__having, requiredColumns, onlyForTablesOrViews);
        const groupBy = this.__groupBy;
        for (let i = 0, length = groupBy.length; i < length; i++) {
            (0, ITableOrView_1.__registerRequiredColumn)(groupBy[i], requiredColumns, onlyForTablesOrViews);
        }
    }
    __buildSelectCount(countAll, params) {
        if (this.groupBy.length > 0) {
            const withView = new WithViewImpl_1.WithViewImpl('result_for_count', this);
            const withs = [];
    ...
    selectOneColumn(column) {
        ...
        (0, values_2.__getValueSourcePrivate)(column).__addWiths(this.__withs);
        return this;
    }
    from(table) {
        this.__finishJoinHaving();
    ...
    leftJoin(source) {
        ...
        (0, ITableOrView_2.__getTableOrViewPrivate)(source).__addWiths(this.__withs);
        return this;
    }
    ...
    on(condition) {
        ...
        (0, values_2.__getValueSourcePrivate)(condition).__addWiths(this.__withs);
        return this;
    }
    __finishJoinHaving() {
        if (this.__lastJoin) {
    ...
    groupBy(...columns) {
        ...
        for (let i = 0, length = columns.length; i < length; i++) {
            ...
            if ((0, values_1.isValueSource)(column)) {
                ...
                (0, ITableOrView_2.__addWiths)(column, this.__withs);
            }
            else {
    ...
    __generateRequiredTableOrView() {
        ...
        if (where) {
            (0, values_2.__getValueSourcePrivate)(where).__registerTableOrView(requiredTableOrView);
        }
        const groupBy = this.__groupBy;
        for (let i = 0, lenght = groupBy.length; i < lenght; i++) {
            const value = groupBy[i];
            (0, values_2.__getValueSourcePrivate)(value).__registerTableOrView(requiredTableOrView);
        }
        const having = this.__having;
        if (having) {
            (0, values_2.__getValueSourcePrivate)(having).__registerTableOrView(requiredTableOrView);
        }
        const joins = this.__joins;
        for (let i = 0, lenght = groupBy.length; i < lenght; i++) {
            const join = joins[i];
            ...
            if (!join.__optional && on) {
                (0, values_2.__getValueSourcePrivate)(on).__registerTableOrView(requiredTableOrView);
            }
        }
        const customization = this.__customization;
        if (customization) {
            (0, ITableOrView_1.__registerTableOrView)(customization.afterSelectKeyword, requiredTableOrView);
            (0, ITableOrView_1.__registerTableOrView)(customization.beforeColumns, requiredTableOrView);
            (0, ITableOrView_1.__registerTableOrView)(customization.customWindow, requiredTableOrView);
            (0, ITableOrView_1.__registerTableOrView)(customization.afterQuery, requiredTableOrView);
        }
    ...
    __getOldValues() {
        ...
        for (let i = 0, length = tablesOrViews.length; i < length; i++) {
            ...
            result = (0, ITableOrView_2.__getTableOrViewPrivate)(tableOrView).__getOldValues();
            if (result) {
                return result;
            }
        }
...
class CompoundSelectQueryBuilder extends AbstractSelect {
    constructor(sqlBuilder, firstQuery, compoundOperator, secondQuery) {
        ...
        (0, ColumnImpl_1.createColumnsFrom)(firstQuery.__columns, this.__columns, new View_1.View(''));
    }
    __registerRequiredColumnInSelect(requiredColumns, onlyForTablesOrViews) {
        (0, ITableOrView_1.__registerRequiredColumn)(this.__firstQuery, requiredColumns, onlyForTablesOrViews);
        (0, ITableOrView_1.__registerRequiredColumn)(this.__secondQuery, requiredColumns, onlyForTablesOrViews);
    }
    __buildSelectCount(countAll, params) {
        const withView = new WithViewImpl_1.WithViewImpl('result_for_count', this);
        const withs = [];
    ...
    __getOldValues() {
        return super.__getOldValues() || (0, ITableOrView_1.__getOldValues)(this.__firstQuery) || (0, ITableOrView_1.__getOldValues)(this.__secondQuery);
    }
}
