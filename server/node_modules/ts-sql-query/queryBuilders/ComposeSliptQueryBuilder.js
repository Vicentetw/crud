...
exports.ComposeSplitQueryBuilder = void 0;
...
class ComposeSplitQueryBuilder {
    ...
    __transformRootObject(errorPrefix, columns, row, index) {
        const result = {};
    ...
    __transformAggregatedArray(errorPrefix, valueSource, value, index) {
        const valueSourcePrivate = (0, values_1.__getValueSourcePrivate)(valueSource);
        if (value === null || value === undefined) {
            if (valueSourcePrivate.__optionalType === 'required') {
                return [];
    ...
    __transformProjectedObject(errorPrefix, pathPrefix, columns, row, index) {
        const result = {};
    ...
    __getOldValueOfColumns(columns) {
        for (const property in columns) {
            ...
            if ((0, values_1.isValueSource)(column)) {
                const oldValues = (0, values_1.__getValueSourcePrivate)(column).__getOldValues();
                if (oldValues) {
                    return oldValues;
                }
            }
    ...
    __registerTableOrViewOfColumns(columns, requiredTablesOrViews) {
        for (const property in columns) {
            const column = columns[property];
            if ((0, values_1.isValueSource)(column)) {
                (0, values_1.__getValueSourcePrivate)(column).__registerTableOrView(requiredTablesOrViews);
            }
            else {
    ...
    __registerTableOrViewWithOfColumns(columns, withs) {
        for (const property in columns) {
            const column = columns[property];
            if ((0, values_1.isValueSource)(column)) {
                (0, values_1.__getValueSourcePrivate)(column).__addWiths(withs);
            }
            else {
    ...
    __registerRequiredColumnOfColmns(columns, requiredColumns, newOnly) {
        for (const property in columns) {
            const column = columns[property];
            if ((0, values_1.isValueSource)(column)) {
                (0, values_1.__getValueSourcePrivate)(column).__registerRequiredColumn(requiredColumns, newOnly);
            }
            else {
