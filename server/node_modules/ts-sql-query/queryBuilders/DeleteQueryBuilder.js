...
class DeleteQueryBuilder extends ComposeSliptQueryBuilder_1.ComposeSplitQueryBuilder {
    constructor(sqlBuilder, table, allowNoWhere) {
        ...
        this.__params = [];
        this.__table = table;
        (0, ITableOrView_1.__getTableOrViewPrivate)(table).__addWiths(this.__withs);
    ...
    where(condition) {
        ...
        (0, values_3.__getValueSourcePrivate)(condition).__addWiths(this.__withs);
        return this;
    }
    and(condition) {
        this.__query = '';
    ...
    leftJoin(source) {
        ...
        (0, ITableOrView_1.__getTableOrViewPrivate)(source).__addWiths(this.__withs);
        return this;
    }
    ...
    customizeQuery(customization) {
        ...
        (0, ITableOrView_1.__addWiths)(customization.afterDeleteKeyword, this.__withs);
        (0, ITableOrView_1.__addWiths)(customization.afterQuery, this.__withs);
        return this;
    }
    returning(columns) {
        this.__finishJoin();
    ...
    returningOneColumn(column) {
        ...
        (0, values_3.__getValueSourcePrivate)(column).__addWiths(this.__withs);
        return this;
    }
}
