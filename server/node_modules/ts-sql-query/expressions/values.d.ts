...
export declare type OptionalType = 'required' | 'requiredInOptionalObject' | 'originallyRequired' | 'optional';
export declare type MergeOptional<OP1 extends OptionalType, OP2 extends OptionalType> = OP1 extends 'any' ? 'optional' : OP2 extends 'any' ? 'optional' : OP1 extends 'required' ? OP2 : OP1 extends 'requiredInOptionalObject' ? (OP2 extends 'required' ? 'requiredInOptionalObject' : OP2) : OP1 extends 'originallyRequired' ? (OP2 extends 'required' | 'requiredInOptionalObject' ? 'originallyRequired' : OP2) : 'optional';
export declare type MergeOptionalUnion<OPTIONAL_TYPE extends OptionalType> = 'any' extends OPTIONAL_TYPE ? 'optional' : 'optional' extends OPTIONAL_TYPE ? 'optional' : 'originallyRequired' extends OPTIONAL_TYPE ? 'originallyRequired' : 'requiredInOptionalObject' extends OPTIONAL_TYPE ? 'requiredInOptionalObject' : 'required';
export declare type OptionalTypeRequiredOrAny<OPTIONAL_TYPE extends OptionalType> = OPTIONAL_TYPE extends 'any' ? any : OPTIONAL_TYPE extends 'required' ? 'required' : any;
declare type OptionalValueType<OPTIONAL_TYPE extends OptionalType> = OPTIONAL_TYPE extends 'optional' ? null | undefined : never;
export declare type ValueSourceValueType<T> = T extends IValueSource<any, infer TYPE, any, infer OPTIONAL_TYPE> ? TYPE | OptionalValueType<OPTIONAL_TYPE> : never;
export declare type ValueSourceValueTypeForResult<T> = T extends IValueSource<any, infer TYPE, any, infer OPTIONAL_TYPE> ? TYPE | (OPTIONAL_TYPE extends 'required' ? never : null) : never;
export declare type ValueSourceValueTypeForObjectResult<T> = T extends IValueSource<any, infer TYPE, any, infer OPTIONAL_TYPE> ? TYPE | (OPTIONAL_TYPE extends 'required' ? never : undefined) : never;
export declare type ValueSourceValueTypeForRequiredInOptionalObject<T> = T extends IValueSource<any, infer TYPE, any, infer OPTIONAL_TYPE> ? TYPE | (OPTIONAL_TYPE extends 'required' | 'requiredInOptionalObject' ? never : undefined) : never;
export declare type ValueSourceValueTypeForOptionalObjectResultSameOuterJoin<T> = T extends IValueSource<any, infer TYPE, any, infer OPTIONAL_TYPE> ? TYPE | (OPTIONAL_TYPE extends 'required' | 'requiredInOptionalObject' | 'originallyRequired' ? never : undefined) : never;
...
export declare type __AggregatedArrayColumns = {
    [P: string]: AnyValueSource | __AggregatedArrayColumns;
};
export declare type __AggregatedArrayMode = 'ResultObject' | 'InnerResultObject';
export declare function isValueSource(value: any): value is AnyValueSource;
export declare function __getValueSourceOfObject(obj: ITableOrView<any>, prop: string): ValueSource<TableOrViewRef<AnyDB>, unknown, unknown, any> | undefined;
