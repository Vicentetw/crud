...
class ColumnImpl extends ValueSourceImpl_1.ValueSourceImpl {
    constructor(table, name, valueType, typeAdapter) {
    ...
    __registerTableOrView(requiredTablesOrViews) {
        (0, ITableOrView_1.__getTableOrViewPrivate)(this.__tableOrView).__registerTableOrView(requiredTablesOrViews);
    }
    ...
    __getOldValues() {
        return (0, ITableOrView_1.__getTableOrViewPrivate)(this.__tableOrView).__getOldValues();
    }
}
exports.ColumnImpl = ColumnImpl;
_a = symbols_1.isColumnObject;
function createColumnsFrom(columns, target, table) {
...
function createColumnsFromInnerObject(columns, target, table, prefix) {
...
function getInnerObjetRuleToApply(columns) {
