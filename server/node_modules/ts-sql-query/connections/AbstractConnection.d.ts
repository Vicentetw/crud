...
import { TableOrViewRef, NoTableOrViewRequired, NoTableOrViewRequiredView, ITableOf, ITableOrViewOf, ITableOrView } from "../utils/ITableOrView";
...
export declare abstract class AbstractConnection<DB extends AnyDB> implements IConnection<DB> {
    ...
    aggregateAsArray<COLUMNS extends AggregatedArrayColumns<DB>>(columns: COLUMNS): AggregatedArrayValueSource<TableOrViewOfAggregatedArray<COLUMNS>, Array<{
...
declare type AggregatedArrayColumns<DB extends AnyDB> = {
    [P: string]: ValueSourceOfDB<DB> | AggregatedArrayColumns<DB>;
};
declare type TableOrViewOfAggregatedArray<TYPE> = ({
